...
main_scene::main_scene(QObject *parent) : QObject(parent)
{
    ...
    // qspheres
    hitable_qentity *SQ1 = new qsphere( this, vec3( 1.5, 0.0, -1.0), vec3( -1.5, 0.0, -1.0), 0.0, 10.1, 0.5, new lambertian( this, vec3(1.0, 0.1, 0.1 ), m_random ));
    ...
    hitable_qentity *SQ3 = new qsphere( this, vec3( 1.1, 0.0, -1.0), vec3( 1.1, 0.0, -1.0), 0.0, 0.1, 0.5,  new metal( this, vec3(0.2, 0.9, 0.1 ), 0.3, m_random ));
    hitable_qentity *SQ4 = new qsphere( this, vec3( -0.95, -0.1, -1.2), vec3( -0.95, -0.1, -1.2), 0.0, 0.1, 0.3,  new dieletric( this, 1.4, m_random ));
