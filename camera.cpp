...
camera::camera( QObject *parent, vec3 look_from, vec3 look_at, vec3 view_up, qreal vfof, qreal aspect, qreal aperture, qreal focal_dist, qreal in_time_1, qreal in_time_2, QRandomGenerator *random) : QObject(parent)
{
    m_random = random;
